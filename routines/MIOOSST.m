...
LOAD(CONF,REQ,CTX,STATE,ERR)
	...
	SET STATE("fsTextChunkBytes")=+$GET(CONF("mioos","fs","textChunkBytes"),262144)
	IF STATE("fsTextChunkBytes")<4096 SET STATE("fsTextChunkBytes")=4096
	IF STATE("fsTextChunkBytes")>262144 SET STATE("fsTextChunkBytes")=262144
...
BOOTARY(STATE,CONF,OBJ)
	...
	SET OBJ("vfs","textChunkBytes")=+$GET(STATE("fsTextChunkBytes"),262144)
	SET OBJ("vfs","textChunkSizeBytes")=+$GET(STATE("fsTextChunkBytes"),262144)
