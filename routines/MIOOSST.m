...
LOAD(CONF,REQ,CTX,STATE,ERR)
	...
	SET STATE("fsMediaInitialBytes")=+$GET(CONF("mioos","download","mediaInitialBytes"),524288)
	SET STATE("fsMediaWarmupBytes")=+$GET(CONF("mioos","download","mediaWarmupBytes"),65536)
...
BOOTARY(STATE,CONF,OBJ)
	...
	SET OBJ("vfs","chunkSize")=+$GET(STATE("fsChunkSize"),524288)
	...
	SET OBJ("vfs","mediaInitialBytes")=+$GET(STATE("fsMediaInitialBytes"),524288)
	SET OBJ("vfs","mediaWarmupBytes")=+$GET(STATE("fsMediaWarmupBytes"),65536)
