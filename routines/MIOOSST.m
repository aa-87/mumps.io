...
LOAD(CONF,REQ,CTX,STATE,ERR)
	...
	SET STATE("loginThemePath")=$GET(CONF("mioos","route","loginTheme"),"/api/mioos/auth/login-theme")
	...
	SET STATE("fsTextChunkPath")=$GET(CONF("mioos","route","fsTextChunk"),"/api/mioos/fs/text-chunk")
	...
	SET STATE("themeDeletePath")=$GET(CONF("mioos","route","themeDelete"),"/api/mioos/theme/delete")
	SET STATE("wsPath")=$GET(CONF("mioos","route","ws"),"/ws/mioos")
	SET STATE("fsEnabled")=+$GET(CONF("mioos","fs","enabled"),1)
	SET STATE("fsChunkSize")=+$GET(CONF("mioos","fs","chunkSize"),860000)
	SET STATE("fsHttpChunkBytes")=+$GET(CONF("mioos","download","httpChunkBytes"),860000)
	SET STATE("fsReadPreviewBytes")=+$GET(CONF("mioos","fs","readPreviewBytes"),860000)
	SET STATE("fsReadWindowBytes")=+$GET(CONF("mioos","fs","readWindowBytes"),860000)
	SET STATE("fsTextChunkBytes")=+$GET(CONF("mioos","fs","textChunkBytes"),860000)
	IF STATE("fsTextChunkBytes")<4096 SET STATE("fsTextChunkBytes")=4096
	IF STATE("fsTextChunkBytes")>860000 SET STATE("fsTextChunkBytes")=860000
	SET STATE("fsTextChunkThresholdBytes")=+$GET(CONF("mioos","fs","textChunkThresholdBytes"),2411725)
	SET STATE("fsMaxTextEditBytes")=+$GET(CONF("mioos","fs","maxTextEditBytes"),+$GET(STATE("fsTextChunkThresholdBytes"),2411725))
	...
	SET STATE("fsMediaWarmupBytes")=+$GET(CONF("mioos","download","mediaWarmupBytes"),860000)
...
BOOTARY(STATE,CONF,OBJ)
	...
	SET OBJ("routes","loginTheme")=$GET(STATE("loginThemePath"))
	...
	SET OBJ("routes","fsTextChunk")=$GET(STATE("fsTextChunkPath"))
	...
	SET OBJ("routes","themeDelete")=$GET(STATE("themeDeletePath"))
	...
	SET OBJ("vfs","readPreviewBytes")=+$GET(STATE("fsReadPreviewBytes"),860000)
	SET OBJ("vfs","readWindowBytes")=+$GET(STATE("fsReadWindowBytes"),860000)
	SET OBJ("vfs","textChunkBytes")=+$GET(STATE("fsTextChunkBytes"),860000)
	SET OBJ("vfs","textChunkSizeBytes")=+$GET(STATE("fsTextChunkBytes"),860000)
	SET OBJ("vfs","textChunkThresholdBytes")=+$GET(STATE("fsTextChunkThresholdBytes"),2411725)
	SET OBJ("vfs","maxTextEditBytes")=+$GET(STATE("fsMaxTextEditBytes"),+$GET(STATE("fsTextChunkThresholdBytes"),2411725))
	SET OBJ("vfs","mediaInitialBytes")=+$GET(STATE("fsMediaInitialBytes"),860000)
	SET OBJ("vfs","mediaWarmupBytes")=+$GET(STATE("fsMediaWarmupBytes"),860000)
