...
LOAD(CONF,REQ,CTX,STATE,ERR)
	...
	SET STATE("fsTextSavePath")=$GET(CONF("mioos","route","fsTextSave"),"/api/mioos/fs/text-save")
	...
	SET STATE("fsTextChunkBytes")=+$GET(CONF("mioos","fs","textChunkBytes"),65536)
	IF STATE("fsTextChunkBytes")<4096 SET STATE("fsTextChunkBytes")=4096
	IF STATE("fsTextChunkBytes")>65536 SET STATE("fsTextChunkBytes")=65536
...
BOOTARY(STATE,CONF,OBJ)
	...
	SET OBJ("routes","fsTextSave")=$GET(STATE("fsTextSavePath"))
	...
	SET OBJ("vfs","textChunkBytes")=+$GET(STATE("fsTextChunkBytes"),65536)
	SET OBJ("vfs","textChunkSizeBytes")=+$GET(STATE("fsTextChunkBytes"),65536)
	SET OBJ("vfs","textChunkSafeMaxBytes")=65536
	SET OBJ("vfs","textChunkThresholdBytes")=+$GET(STATE("fsTextChunkThresholdBytes"),2411725)
	SET OBJ("vfs","maxTextEditBytes")=0
