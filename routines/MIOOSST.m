...
LOAD(CONF,REQ,CTX,STATE,ERR)
	...
	SET STATE("fsTextChunkBytes")=+$GET(CONF("mioos","fs","textChunkBytes"),131072)
...
BOOTARY(STATE,CONF,OBJ)
	...
	SET OBJ("vfs","textChunkBytes")=+$GET(STATE("fsTextChunkBytes"),131072)
	SET OBJ("vfs","textChunkSizeBytes")=+$GET(STATE("fsTextChunkBytes"),131072)
