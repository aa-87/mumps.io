...
LOAD(CONF,REQ,CTX,STATE,ERR)
	...
	SET STATE("a11yReducedMotionToggle")=+$GET(CONF("mioos","desktop","accessibility","reducedMotionToggle"),1)
	SET STATE("a11yPersistence")=$GET(CONF("mioos","desktop","accessibility","persistence"),"localstorage-shell-accessibility")
	SET STATE("a11yShortcutShowDesktop")=$GET(CONF("mioos","desktop","accessibility","keyboardShortcuts","showDesktop"),"Meta+D")
	SET STATE("a11yShortcutWindowSwitcher")=$GET(CONF("mioos","desktop","accessibility","keyboardShortcuts","windowSwitcher"),"Alt+Tab")
	SET STATE("a11yShortcutCloseFocused")=$GET(CONF("mioos","desktop","accessibility","keyboardShortcuts","closeFocusedWindow"),"Shift+Escape")
	SET STATE("a11yShortcutOpenDiagnostics")=$GET(CONF("mioos","desktop","accessibility","keyboardShortcuts","openDiagnostics"),"Ctrl+Shift+Escape")
	SET STATE("windowPersistence")=$GET(CONF("mioos","desktop","windowPersistence"),"localstorage-open-window-layout")
	SET STATE("desktopLayoutPersistence")=$GET(CONF("mioos","desktop","desktopLayoutPersistence"),"localstorage-icon-layout")
...
BOOTARY(STATE,CONF,OBJ)
	...
	SET OBJ("desktop","accessibility","reducedMotionToggle")=+$GET(STATE("a11yReducedMotionToggle"),1)
	SET OBJ("desktop","accessibility","persistence")=$GET(STATE("a11yPersistence"),"localstorage-shell-accessibility")
	SET OBJ("desktop","accessibility","keyboardShortcuts","showDesktop")=$GET(STATE("a11yShortcutShowDesktop"),"Meta+D")
	SET OBJ("desktop","accessibility","keyboardShortcuts","windowSwitcher")=$GET(STATE("a11yShortcutWindowSwitcher"),"Alt+Tab")
	SET OBJ("desktop","accessibility","keyboardShortcuts","closeFocusedWindow")=$GET(STATE("a11yShortcutCloseFocused"),"Shift+Escape")
	SET OBJ("desktop","accessibility","keyboardShortcuts","openDiagnostics")=$GET(STATE("a11yShortcutOpenDiagnostics"),"Ctrl+Shift+Escape")
	...
	SET OBJ("desktop","performance","windowPersistence")=$GET(STATE("windowPersistence"),"localstorage-open-window-layout")
	SET OBJ("desktop","performance","desktopLayoutPersistence")=$GET(STATE("desktopLayoutPersistence"),"localstorage-icon-layout")
