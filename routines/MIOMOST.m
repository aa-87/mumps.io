...
START
	...
	DO OK^MIOTASSERT(OUT["data-shell-dragdrop=""xp""","[MIOMOST][T003][dragdrop token]")
	DO OK^MIOTASSERT(OUT["data-desktop-dropzone=""1""","[MIOMOST][T003][desktop dropzone token]")
	DO OK^MIOTASSERT(OUT["data-explorer-dropzone=""1""","[MIOMOST][T003][explorer dropzone token]")
	DO OK^MIOTASSERT(OUT["data-drop-operation-default=""move""","[MIOMOST][T003][drop default token]")
	DO OK^MIOTASSERT(OUT["data-drop-modifier-copy=""ctrl""","[MIOMOST][T003][drop copy token]")
	DO OK^MIOTASSERT(OUT["data-drop-modifier-shortcut=""alt""","[MIOMOST][T003][drop shortcut token]")
	DO OK^MIOTASSERT(OUT["Move here","[MIOMOST][T003][drop move copy]")
	DO OK^MIOTASSERT(OUT["Create shortcut here","[MIOMOST][T003][drop shortcut copy]")
	...
	DO EQ^MIOTASSERT($GET(OBJ("desktop","dragDropModel")),"xp-shell-semantics","[MIOMOST][T004][dragdrop model]")
	DO EQ^MIOTASSERT($GET(OBJ("desktop","dragDropDefaultOperation")),"move","[MIOMOST][T004][dragdrop default]")
	DO EQ^MIOTASSERT($GET(OBJ("desktop","dragDropCopyModifier")),"ctrl","[MIOMOST][T004][dragdrop copy modifier]")
	DO EQ^MIOTASSERT($GET(OBJ("desktop","dragDropShortcutModifier")),"alt","[MIOMOST][T004][dragdrop shortcut modifier]")
	DO EQ^MIOTASSERT($GET(OBJ("desktop","dragDropBridge")),"layout-preview-until-websocket-fs-bridge","[MIOMOST][T004][dragdrop bridge]")
	...
	DO EQ^MIOTASSERT($GET(VM("shellChrome","dragDropModel")),"xp-shell-semantics","[MIOMOST][T014][dragdrop model]")
	DO EQ^MIOTASSERT($GET(VM("shellChrome","dragDropDefaultOperation")),"move","[MIOMOST][T014][dragdrop default]")
	DO EQ^MIOTASSERT($GET(VM("shellChrome","dragDropCopyModifier")),"ctrl","[MIOMOST][T014][dragdrop copy modifier]")
	DO EQ^MIOTASSERT($GET(VM("shellChrome","dragDropShortcutModifier")),"alt","[MIOMOST][T014][dragdrop shortcut modifier]")
