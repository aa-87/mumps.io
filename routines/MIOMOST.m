...
START
	...
	DO OK^MIOTASSERT(OUT["data-xp-marquee=""1""","[MIOMOST][T003][xp marquee token]")
	DO OK^MIOTASSERT(OUT["data-xp-rename=""inline-f2""","[MIOMOST][T003][xp rename token]")
	DO OK^MIOTASSERT(OUT["data-xp-delete=""recycle-bin-routing""","[MIOMOST][T003][xp delete token]")
	DO OK^MIOTASSERT(OUT["data-xp-context-verbs=""1""","[MIOMOST][T003][xp verbs token]")
	DO OK^MIOTASSERT(OUT["data-selection-marquee=""1""","[MIOMOST][T003][marquee overlay token]")
	DO OK^MIOTASSERT(OUT["Arrange Icons by Name","[MIOMOST][T003][arrange icons copy]")
	DO OK^MIOTASSERT(OUT["Empty Recycle Bin","[MIOMOST][T003][empty recycle copy]")
	DO OK^MIOTASSERT(OUT["Marquee selection, inline rename, and recycle-bin routing now harden desktop verbs toward XP parity.","[MIOMOST][T003][xp verbs copy]")
	...
	DO EQ^MIOTASSERT($GET(OBJ("desktop","desktopSelectionExtension")),"marquee-and-multi-select","[MIOMOST][T004][desktop marquee]")
	DO EQ^MIOTASSERT($GET(OBJ("desktop","renameBehavior")),"inline-f2-custom-folders","[MIOMOST][T004][rename behavior]")
	DO EQ^MIOTASSERT($GET(OBJ("desktop","deleteBehavior")),"recycle-bin-routing","[MIOMOST][T004][delete behavior]")
	DO EQ^MIOTASSERT($GET(OBJ("desktop","recycleBinModel")),"soft-delete-custom-folders","[MIOMOST][T004][recycle model]")
	...
	DO EQ^MIOTASSERT(+$GET(OBJ("desktop","vfs","enabled")),1,"[MIOMOST][T004][vfs enabled]")
	DO EQ^MIOTASSERT($GET(OBJ("desktop","vfs","storage")),"globals-only","[MIOMOST][T004][vfs storage]")
	DO EQ^MIOTASSERT($GET(OBJ("desktop","vfs","ownership")),"per-user","[MIOMOST][T004][vfs ownership]")
	DO EQ^MIOTASSERT($GET(OBJ("desktop","vfs","uploadModel")),"browser-drop-or-picker","[MIOMOST][T004][vfs upload model]")
	DO EQ^MIOTASSERT($GET(OBJ("desktop","vfs","downloadModel")),"browser-save","[MIOMOST][T004][vfs download model]")
	DO OK^MIOTASSERT(+$GET(OBJ("desktop","vfs","summary","totalFiles"))>0,"[MIOMOST][T004][vfs file count]")
	DO EQ^MIOTASSERT($GET(OBJ("view","vfs","roots",1,"key")),"my-documents","[MIOMOST][T004][vfs root key]")
	DO OK^MIOTASSERT(+$GET(OBJ("view","vfs","entryCount"))>0,"[MIOMOST][T004][vfs entry count]")
	...
	DO EQ^MIOTASSERT($GET(VM("shellChrome","desktopSelectionExtension")),"marquee-and-multi-select","[MIOMOST][T014][desktop marquee]")
	DO EQ^MIOTASSERT($GET(VM("shellChrome","renameBehavior")),"inline-f2-custom-folders","[MIOMOST][T014][rename behavior]")
	DO EQ^MIOTASSERT($GET(VM("shellChrome","deleteBehavior")),"recycle-bin-routing","[MIOMOST][T014][delete behavior]")
	DO EQ^MIOTASSERT($GET(VM("shellChrome","recycleBinModel")),"soft-delete-custom-folders","[MIOMOST][T014][recycle model]")
