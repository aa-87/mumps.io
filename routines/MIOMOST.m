...
START
	...
	DO OK^MIOTASSERT(OUT["data-theme-key=""clinical-blue""","[MIOMOST][T003][theme key token]")
	DO OK^MIOTASSERT(OUT["data-theme-mode=""light""","[MIOMOST][T003][theme mode token]")
	...
	DO OK^MIOTASSERT(OUT["data-shell-services=""xp-classic""","[MIOMOST][T003][xp shell services token]")
	DO OK^MIOTASSERT(OUT["data-system-place=""my-computer""","[MIOMOST][T003][my computer token]")
	DO OK^MIOTASSERT(OUT["data-system-place=""my-documents""","[MIOMOST][T003][my documents token]")
	DO OK^MIOTASSERT(OUT["data-system-place=""my-network-places""","[MIOMOST][T003][my network token]")
	DO OK^MIOTASSERT(OUT["data-system-place=""recycle-bin""","[MIOMOST][T003][recycle bin token]")
	DO OK^MIOTASSERT(OUT["data-shell-shortcuts=""1""","[MIOMOST][T003][shortcut token]")
	...
	DO EQ^MIOTASSERT($GET(OBJ("desktop","theme","currentKey")),"clinical-blue","[MIOMOST][T004][theme current key]")
	...
	DO EQ^MIOTASSERT($GET(OBJ("desktop","shellServicesModel")),"xp-classic-shell-services","[MIOMOST][T004][shell services model]")
	DO EQ^MIOTASSERT($GET(OBJ("desktop","systemPlaces")),"my-computer,my-documents,my-network-places,recycle-bin","[MIOMOST][T004][system places]")
	DO EQ^MIOTASSERT(+$GET(OBJ("desktop","shortcutServicesEnabled")),1,"[MIOMOST][T004][shortcut services]")
	DO EQ^MIOTASSERT(+$GET(OBJ("desktop","recycleBinEnabled")),1,"[MIOMOST][T004][recycle bin enabled]")
	...
	DO EQ^MIOTASSERT($GET(ARR("catalog","themes",8,"key")),"xp-olive","[MIOMOST][T014][xp olive]")
	DO EQ^MIOTASSERT($GET(ARR("catalog","themes",9,"key")),"xp-silver","[MIOMOST][T014][xp silver]")
	...
	DO EQ^MIOTASSERT($GET(VM("shellChrome","shellServicesModel")),"xp-classic-shell-services","[MIOMOST][T014][shell services model]")
	DO EQ^MIOTASSERT(+$GET(VM("shellChrome","shortcutServicesEnabled")),1,"[MIOMOST][T014][shortcut services]")
	DO EQ^MIOTASSERT(+$GET(VM("shellChrome","recycleBinEnabled")),1,"[MIOMOST][T014][recycle enabled]")
