...
SHELL(STATE,CONF,ROOT)
	...
	SET @ROOT@("notificationStyle")="xp-classic-flyout"
	SET @ROOT@("tray",1,"key")="notifications",@ROOT@("tray",1,"label")="Notifications",@ROOT@("tray",1,"icon")="✦",@ROOT@("tray",1,"action")="notifications",@ROOT@("tray",1,"className")="is-notify"
	SET @ROOT@("tray",2,"key")="account",@ROOT@("tray",2,"label")="Account",@ROOT@("tray",2,"icon")="☺",@ROOT@("tray",2,"action")="account",@ROOT@("tray",2,"className")="is-account"
	SET @ROOT@("tray",3,"key")="workspace",@ROOT@("tray",3,"label")="Workspace ready",@ROOT@("tray",3,"icon")="✓",@ROOT@("tray",3,"action")="refresh",@ROOT@("tray",3,"className")="is-workspace"
	SET @ROOT@("tray",4,"key")="power",@ROOT@("tray",4,"label")="Power options",@ROOT@("tray",4,"icon")="⏻",@ROOT@("tray",4,"action")="power",@ROOT@("tray",4,"className")="is-power"
	SET @ROOT@("accountMenu",1,"key")="settings",@ROOT@("accountMenu",1,"label")="Control Panel",@ROOT@("accountMenu",1,"copy")="Open personal desktop preferences and shell options.",@ROOT@("accountMenu",1,"action")="launch:settings"
	SET @ROOT@("accountMenu",2,"key")="collaboration",@ROOT@("accountMenu",2,"label")="Collaboration",@ROOT@("accountMenu",2,"copy")="Open the team chat surface and unread rooms.",@ROOT@("accountMenu",2,"action")="launch:collaboration"
	...
	SET @ROOT@("dragDropModel")="xp-shell-semantics"
	SET @ROOT@("dragDropDefaultOperation")="move"
	SET @ROOT@("dragDropCopyModifier")="ctrl"
