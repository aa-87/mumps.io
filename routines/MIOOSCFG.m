...
DEFS(OUT)
	...
	DO ADD(.OUT,"mioos.upload.chunkBytes","transport","HTTP upload chunk bytes","integer",860000,860000,860000,"","mioos|upload|chunkBytes","Chunk size for HTTP upload slices. The server clamps values to the MAXSTRING-safe 860000-byte baseline.","Applies to new uploads.")
