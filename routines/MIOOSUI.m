...
DESKCTX(STATE,CONF,DATA)
	...
	SET DATA("brandSubtitle")=$GET(STATE("brandSubtitle"),"MUMPS powered Windows 7 style desktop")
	...
	SET DATA("themeKey")=$GET(STATE("themeKey"),"win7-sample-light")
	...
	SET DATA("shellChrome")=$GET(STATE("shellChrome"),"win7-sample")
	SET DATA("taskbarStyle")=$GET(STATE("taskbarStyle"),"win7-sample")
	SET DATA("startMenuStyle")=$GET(STATE("startMenuStyle"),"win7-sample")
