...
DESKCTX(STATE,CONF,DATA)
	...
	SET DATA("wallpaperUrl")=$SELECT($GET(STATE("transportMode"),"websocket")="websocket":"",1:$GET(STATE("wallpaperUrl")))
...
THEMEINL(STATE)
	...
	IF '+$GET(STATE("authenticated"),0),URL["/api/mioos/fs/blob" SET URL=""
	IF $GET(STATE("transportMode"),"websocket")'="http",URL["/api/mioos/fs/blob" SET URL=""
	IF URL["data:" SET URL=""
