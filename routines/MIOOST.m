...
T041
	...
	DO EQ^MIOTASSERT(+$GET(OBJ("vfs","chunkSize")),524288,"[MIOOST][T041][vfs chunk size]")
...
T044
	...
	DO EQ^MIOTASSERT(+$GET(^MIO("MIOOS","FS","INFO",ID,"chunkSize")),524288,"[MIOOST][T044][promoted chunk size]")
...
T049
	...
	DO BOOTARY^MIOOSST(.STATE,.CONF,.BOOT)
	DO EQ^MIOTASSERT(+$GET(BOOT("vfs","uploadChunkBytes")),524288,"[MIOOST][T049][upload chunk bytes]")
	DO EQ^MIOTASSERT(+$GET(BOOT("vfs","uploadConcurrency")),3,"[MIOOST][T049][upload concurrency]")
	DO EQ^MIOTASSERT(+$GET(BOOT("vfs","httpChunkBytes")),524288,"[MIOOST][T049][http chunk bytes]")
	DO EQ^MIOTASSERT(+$GET(BOOT("vfs","chunkSize")),524288,"[MIOOST][T049][chunk size]")
