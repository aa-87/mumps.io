...
T002
	...
	DO EQ^MIOTASSERT($GET(OBJ("desktop","commandTransport")),"mixed-http-websocket","[MIOOST][T002][transport]")
	DO EQ^MIOTASSERT($GET(OBJ("desktop","realtimeContract")),"mixed-http-websocket","[MIOOST][T002][realtime]")
...
T004
	...
	DO EQ^MIOTASSERT($GET(OBJ("realtimeContract")),"mixed-http-websocket","[MIOOST][T004][realtime contract]")
...
T027
		...
		DO EQ^MIOTASSERT(+$GET(OBJ("desktop","moduleSystem","enabled")),1,"[MIOOST][T027][module system enabled]")
		DO OK^MIOTASSERT(+$GET(OBJ("desktop","moduleSystem","moduleCount"))>0,"[MIOOST][T027][module count restored]")
		DO EQ^MIOTASSERT($GET(OBJ("desktop","moduleSystem","appCatalogKey")),"app-catalog","[MIOOST][T027][catalog key]")
		DO EQ^MIOTASSERT($GET(OBJ("routes","tableQuery")),"/api/mioos/table/query","[MIOOST][T027][table query route]")
...
T035
		...
		DO EQ^MIOTASSERT(+$GET(BOOT("desktop","moduleSystem","enabled")),1,"[MIOOST][T035][modules enabled]")
		DO EQ^MIOTASSERT(+$GET(BOOT("desktop","debugCenter","enabled")),0,"[MIOOST][T035][debug disabled]")
		DO EQ^MIOTASSERT(+$GET(BOOT("desktop","moduleSystem","appCatalogEnabled")),1,"[MIOOST][T035][catalog enabled]")
		DO OK^MIOTASSERT(+$GET(BOOT("desktop","components","table"))=1,"[MIOOST][T035][table component restored]")
		QUIT
		;
T036
...
T058
	...
	DO OK^MIOTASSERT($$FILEHAS("public/mioos/app/mioos_explorer.js","explorerColumns: function"),"[MIOOST][T058][explorerColumns runtime alias]")
	...
	DO OK^MIOTASSERT($$FILEHAS("public/mioos/app/mioos_shell_ui.js","resizeColumn: function"),"[MIOOST][T058][explorer resize method]")
	DO OK^MIOTASSERT($$FILEHAS("public/mioos/app/mioos_shell_ui.js","cellValue: function"),"[MIOOST][T058][explorer cell method]")
	DO OK^MIOTASSERT($$FILEHAS("public/mioos/app/mioos_wm.js","function nextWindowId"),"[MIOOST][T058][window manager nextWindowId]")
