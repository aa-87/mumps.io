...
T037
	...
	KILL EP DO AMATCH("[MIOOST][T037][table query]","POST","/api/mioos/table/query",1,"TABLEQUERY^MIOOSAPI","/api/mioos/table/query",.EP)
	KILL EP DO AMATCH("[MIOOST][T037][module catalog]","POST","/api/mioos/modules/catalog",1,"MODULECATALOG^MIOOSAPI","/api/mioos/modules/catalog",.EP)
...
T056
	...
	DO OK^MIOTASSERT($GET(STATE2("wallpaperUrl"))["/api/mioos/fs/blob?id=","[MIOOST][T056][persisted wallpaper blob state]")
	DO OK^MIOTASSERT(STYLE2["url('/api/mioos/fs/blob?id=","[MIOOST][T056][persisted wallpaper style]")
