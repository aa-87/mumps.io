...
T047
	...
	DO EQ^MIOTASSERT(+$GET(BOOT("vfs","mediaInitialBytes")),524288,"[MIOOST][T047][boot media bytes]")
...
T049
	...
	DO EQ^MIOTASSERT(+$GET(BOOT("vfs","mediaInitialBytes")),524288,"[MIOOST][T049][media initial bytes]")
