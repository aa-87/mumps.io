...
T084
	...
	DO OK^MIOTASSERT($$FILEHAS("public/mioos/app/mioos_explorer.js","saveTextViaHttp")&$$FILEHAS("public/mioos/app/mioos_explorer.js","/api/mioos/fs/text-save"),"[MIOOST][T084][frontend small HTTP text save command]")
...
T091
	...
	DO OK^MIOTASSERT($$FILEHAS("public/mioos/app/mioos_explorer.js","loadStrategy: 'explicit-complete-http'")&$$FILEHAS("public/mioos/app/mioos_explorer.js","textViewerLoadCompleteFile"),"[MIOOST][T091][large file explicit editable load mode]")
...
T092
	...
	DO OK^MIOTASSERT($$FILEHAS("public/mioos/app/mioos_explorer.js","stream.retryPolicy = 'manual-only'")&$$FILEHAS("public/mioos/app/mioos_explorer.js","MIOOS_TEXT_LOAD_RETRY_LIMIT"),"[MIOOST][T092][failed chunks are bounded/manual retry only]")
	...
	DO OK^MIOTASSERT($$FILEHAS("public/mioos/app/mioos_explorer.js","loadStrategy: 'explicit-complete-http'")&$$FILEHAS("public/mioos/app/mioos_explorer.js","scrollLoadDisabled: true"),"[MIOOST][T092][large text explicit open/edit mode]")
...
T093
	...
	DO OK^MIOTASSERT($$FILEHAS("public/mioos/app/mioos_shell_ui.js","data-text-scroll-load-disabled"),"[MIOOST][T093][wheel no longer arms text scroll loading]")
	DO OK^MIOTASSERT($$FILEHAS("public/mioos/app/mioos_shell_ui.js","armTextScroll: function () { return false; }"),"[MIOOST][T093][pointer scroll arm disabled]")
	DO OK^MIOTASSERT($$FILEHAS("public/mioos/app/mioos_shell_ui.js","onTextScroll: function () { return false; }"),"[MIOOST][T093][pointer drag no scroll load]")
	DO OK^MIOTASSERT($$FILEHAS("public/mioos/app/mioos_shell_ui.js","data-text-scroll-load-disabled"),"[MIOOST][T093][touch no longer arms text scroll loading]")
	DO OK^MIOTASSERT($$FILEHAS("public/mioos/app/mioos_explorer.js","scrollLoadDisabled: true"),"[MIOOST][T093][touch drag no scroll load]")
	DO OK^MIOTASSERT($$FILEHAS("public/mioos/app/mioos_explorer.js","loadStrategy: 'explicit-complete-http'"),"[MIOOST][T093][keyboard no longer arms text scroll]")
	DO OK^MIOTASSERT($$FILEHAS("public/mioos/app/mioos_explorer.js","scrollLoadDisabled || stream.loadStrategy === 'explicit-complete-http'"),"[MIOOST][T093][idle scroll ignored]")
	...
	DO OK^MIOTASSERT($$FILEHAS("public/mioos/app/mioos_explorer.js","stream.retryPolicy = 'manual-only'")&$$FILEHAS("public/mioos/app/mioos_explorer.js","bounded-manual-only"),"[MIOOST][T093][manual retry policy]")
	...
	DO OK^MIOTASSERT($$FILEHAS("public/mioos/app/mioos_shell_ui.js","Editable text file loaded with explicit HTTP chunks"),"[MIOOST][T093][large edit explicit]")
...
T094
	...
	DO OK^MIOTASSERT($$FILEHAS("docs/mioos/README.md","ROI 101"),"[MIOOST][T094][docs updated]")
...
T097
	...
	DO OK^MIOTASSERT($$FILEHAS("public/mioos/app/mioos_shell_ui.js","title=""PDF preview""")&$$FILEHAS("public/mioos/app/mioos_explorer.js","openPdfViewerWindow"),"[MIOOST][T097][pdf fallback]")
...
T101
	...
	DO OK^MIOTASSERT($$FILEHAS("public/mioos/app/mioos_explorer.js","function textViewerRevisionMarker(meta)"),"[MIOOST][T101][text revision helper defined]")
