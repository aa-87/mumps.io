...
T084
	...
	DO OK^MIOTASSERT($$FILEHAS("public/mioos/app/mioos_explorer.js","fs.text.save"),"[MIOOST][T084][frontend text save command]")
...
T093
	...
	DO OK^MIOTASSERT(JSON["fullEditOnDemand","[MIOOST][T093][large save unbounded marker]")
...
T097
	...
	DO OK^MIOTASSERT($$FILEHAS("public/mioos/app/mioos_marked.js","inline-sanitized-markdown-no-iframe"),"[MIOOST][T097][markdown inline strategy]")
...
T098
	...
	DO OK^MIOTASSERT($$FILEHAS("public/mioos/app/mioos_shell_ui.js","data-markdown-inline-preview"),"[MIOOST][T098][markdown inline marker]")
	...
	DO OK^MIOTASSERT($$FILEHAS("public/mioos/app/mioos_shell_ui.js","--mioos-markdown-preview-zoom"),"[MIOOST][T098][markdown zoom inline]")
...
T099
	...
	DO OK^MIOTASSERT($$FILEHAS("public/mioos/app/mioos_explorer.js","textViewerVerifySaveRevision")&$$FILEHAS("public/mioos/app/mioos_explorer.js","openRevisionMarker"),"[MIOOST][T099][save revision hook marker]")
	DO EQ^MIOTASSERT($$FILEHAS("public/mioos/app/mioos_explorer.js","stale_text_revision_conflict"),0,"[MIOOST][T099][no false stale revision conflict marker]")
...
T100
	...
	DO OK^MIOTASSERT($$FILEHAS("public/mioos/app/mioos_explorer.js","textViewerLoadCompleteFile(windowId)")&$$FILEHAS("public/mioos/app/mioos_explorer.js","text_file_too_large_for_browser_editor"),"[MIOOST][T100][large edit guarded complete load]")
	...
	DO OK^MIOTASSERT($$FILEHAS("public/mioos/app/mioos_explorer.js","textViewerBrowserEditMaxBytes"),"[MIOOST][T100][client edit byte cap restored as browser safety guard]")
	DO OK^MIOTASSERT($$FILEHAS("routines/MIOOSWS.m","fs_text_save_requires_chunked"),"[MIOOST][T100][backend oversized save uses chunked guard]")
...
T101
	...
	DO OK^MIOTASSERT($$FILEHAS("public/mioos/app/mioos_explorer.js","textViewerVerifySaveRevision"),"[MIOOST][T101][save revision hook present]")
	DO EQ^MIOTASSERT($$FILEHAS("public/mioos/app/mioos_explorer.js","stale_text_revision_conflict"),0,"[MIOOST][T101][no false stale revision conflict]")
	DO OK^MIOTASSERT($$FILEHAS("public/mioos/app/mioos_explorer.js","textViewerShouldVirtualize(this, item || {}) || size > browserMax"),"[MIOOST][T101][large open threshold gate]")
	DO OK^MIOTASSERT($$FILEHAS("public/mioos/app/mioos_explorer.js","Large or unknown-size text file opened as a one-chunk preview"),"[MIOOST][T101][large open one chunk preview]")
	DO OK^MIOTASSERT($$FILEHAS("public/mioos/app/mioos_shell_ui.js","data-html-iframe-preview")&$$FILEHAS("public/mioos/app/mioos_explorer.js","htmlIframePreview"),"[MIOOST][T101][html direct iframe preview]")
	DO EQ^MIOTASSERT($$FILEHAS("public/mioos/app/mioos_explorer.js","Opening editable HTML through explicit HTTP chunk load")&$$FILEHAS("public/mioos/app/mioos_explorer.js","textStream: stream"),0,"[MIOOST][T101][html viewer does not chunk-load]")
...
T102
	...
	QUIT
		;
T103
	DO OK^MIOTASSERT($$FILEHAS("public/mioos/app/mioos_shell_ui.js","showInlineMarkdownPreview"),"[MIOOST][T103][markdown inline preview computed]")
	DO OK^MIOTASSERT($$FILEHAS("public/mioos/app/mioos_shell_ui.js","data-markdown-inline-preview"),"[MIOOST][T103][markdown inline marker]")
	DO OK^MIOTASSERT($$FILEHAS("public/mioos/app/mioos_shell_ui.js","markdownInlineHtml"),"[MIOOST][T103][markdown inline html binding]")
	DO OK^MIOTASSERT($$FILEHAS("public/mioos/app/mioos_marked.js","inline-sanitized-markdown-no-iframe"),"[MIOOST][T103][marked inline no iframe strategy]")
	DO OK^MIOTASSERT($$FILEHAS("public/mioos/app/mioos_marked.js","sanitizeInlineHtml"),"[MIOOST][T103][marked sanitizes inline html]")
	DO OK^MIOTASSERT($$FILEHAS("public/mioos/mioos.css","mioos-markdown-inline-preview"),"[MIOOST][T103][markdown inline css]")
	DO OK^MIOTASSERT($$FILEHAS("public/mioos/mioos.css","theme-dark-mode .mioos-text-virtual-viewer .mioos-markdown-inline-preview"),"[MIOOST][T103][markdown dark css]")
	DO OK^MIOTASSERT($$FILEHAS("public/mioos/app/mioos_shell_ui.js","data-html-iframe-preview"),"[MIOOST][T103][html iframe remains]")
	DO OK^MIOTASSERT($$FILEHAS("public/mioos/app/mioos_explorer.js","MIOOS_TEXT_MAX_CHUNK_REQUESTS"),"[MIOOST][T103][max text chunk requests]")
	DO OK^MIOTASSERT($$FILEHAS("public/mioos/app/mioos_explorer.js","text_chunk_duplicate_request"),"[MIOOST][T103][duplicate text chunk guard]")
	DO OK^MIOTASSERT($$FILEHAS("public/mioos/app/mioos_explorer.js","text_chunk_non_increasing_next_offset"),"[MIOOST][T103][non increasing offset guard]")
	DO OK^MIOTASSERT($$FILEHAS("public/mioos/app/mioos_explorer.js","stream.editableContent = pieces.join"),"[MIOOST][T103][full load visible append]")
	DO OK^MIOTASSERT($$FILEHAS("public/mioos/app/mioos_shell_ui.js","!stream.fullContentLoaded"),"[MIOOST][T103][codemirror waits full load]")
	DO OK^MIOTASSERT($$FILEHAS("public/mioos/app/mioos_explorer.js","loadFailedTerminal"),"[MIOOST][T103][load failure stops reentry]")
	DO OK^MIOTASSERT($$FILEHAS("docs/mioos/README.md","ROI 105/106")&$$FILEHAS("docs/mioos/UI_Modules.md","ROI 105/106")&$$FILEHAS("mioos_llm.md","ROI 105/106"),"[MIOOST][T103][docs updated]")
	QUIT
