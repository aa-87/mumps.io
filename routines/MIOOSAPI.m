...
FSBLOB(DEV,CONF,REQ,CTX)
	...
	SET MEDIAINIT=+$GET(CONF("mioos","download","mediaInitialBytes"),2097152)
...
SENDVFS(DEV,CONF,RID,OFFSET,LEN,ERR)
	NEW CHSZ,POS,END,IDX,SEG,SEGBYTES,OFFINSEG,TAKE,PART,SEND,TOTAL,SENDBUF,SENDCH,OUTCH,FLUSHLEN
