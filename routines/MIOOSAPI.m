...
FSBLOB(DEV,CONF,REQ,CTX)
	...
	SET MEDIAINIT=+$GET(CONF("mioos","download","mediaInitialBytes"),524288)
	IF MEDIAINIT<65536 SET MEDIAINIT=65536
	SET MEDIAWARM=+$GET(CONF("mioos","download","mediaWarmupBytes"),65536)
...
SENDVFS(DEV,CONF,RID,OFFSET,LEN,ISMEDIA,MEDIAWARM,ERR)
	...
	SET SENDCH=+$GET(CONF("mioos","download","httpChunkBytes"),1048576)
	IF SENDCH<32768 SET SENDCH=32768
	IF SENDCH>(262144*2) SET SENDCH=(262144*2)
	...
	IF +$GET(ISMEDIA)=1,SENDCH>65536 SET SENDCH=65536
	SET POS=+$GET(OFFSET)
	IF POS<0 SET POS=0
	SET LEN=+$GET(LEN)
	IF LEN<1 QUIT
