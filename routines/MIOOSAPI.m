...
SENDVFS(DEV,CONF,RID,OFFSET,LEN,ERR)
	NEW CHSZ,POS,END,IDX,SEG,SEGBYTES,OFFINSEG,TAKE,PART,SEND,TOTAL,SENDBUF,SENDCH
	...
	. IF $ZLENGTH(SENDBUF)'<SENDCH DO WOUT^MIOSTATIC(.DEV,SENDBUF) SET SENDBUF=""
	. SET POS=POS+SEND
	IF '$DATA(ERR("error")),SENDBUF'="" DO WOUT^MIOSTATIC(.DEV,SENDBUF)
	QUIT
	;
	;
ISTRUE(X)
