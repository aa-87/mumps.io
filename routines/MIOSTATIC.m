...
GETMETA(CONF,FS,META)
	KILL META
	NEW MAXB SET MAXB=+$GET(CONF("server","static","maxEtagBytes"),10485760)
	...
	IF CHSZ>1048576 SET CHSZ=10485760
...
SENDRANGE(DEV,CONF,FS,OFF,LEN)
	NEW CHSZ SET CHSZ=+$GET(CONF("server","static","readChunkBytes"),1048576)
	IF CHSZ<1024 SET CHSZ=1024
	IF CHSZ>10485760 SET CHSZ=10485760
