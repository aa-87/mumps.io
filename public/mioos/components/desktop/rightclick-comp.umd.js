  ...
  window["rightclick-comp"]={
    ...
    mounted() {
      document.addEventListener("contextmenu", function (event) {
        ...
        const rightClickTemp = document.querySelector('[data-attr="rightclickmenu"]');
    ...
    template: `
    <div data-attr="rightclickmenu" @mouseleave="closeMenu" @click="closeMenu" class="w-40 hidden absolute border-zinc-400 border-[1px]  bg-white p-[2px] rc-shadow">
