# How blocks, partials, and parents work (MIOTPL2)
...
If the call-site tag is standalone, MIOTPL2 captures call-site indentation and applies it to the rendered partial.
...
2. MIOTPL2 captures all `{{$block}}...{{/block}}` definitions inside that parent call.
3. MIOTPL2 renders the parent template.
